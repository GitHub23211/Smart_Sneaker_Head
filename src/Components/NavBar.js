...
const NavBar = () =>{
   ...
   const menulinkstyle = {color:"black", textDecoration: 'none',mt:"10px"}
      ...
      return(
         <AppBar position="relative" style={navStyle}>
            <Toolbar>
               ...
               >
                <Link to = "/productlist"  style={menulinkstyle}><MenuItem onClick = {(event) => handleCategory(event, "Nike")}>Nike</MenuItem></Link>
                <Link to = "/productlist"  style={menulinkstyle}><MenuItem onClick = {(event) => handleCategory(event, "Adidas")}>Adidas</MenuItem></Link>
                <Link to = "/productlist"  style={menulinkstyle}><MenuItem onClick = {(event) => handleCategory(event, "Jordans")}>Jordans</MenuItem></Link>
                <Link to = "/productlist"  style={menulinkstyle}><MenuItem onClick = {(event) => handleCategory(event, "Asics")}>Asics</MenuItem></Link>
               ...
               <Box sx={{marginLeft:"10px"}}> <Link to ="/register" style={linkstyle} >REGISTER</Link></Box>
            </Toolbar>
         </AppBar>   
      )
      ...
      return (
         <AppBar position="relative" style={navStyle}>
            <Toolbar>
               ...
               <Box sx={{marginLeft:"20PX"}}> <Link onClick = {(event) => handleCategory(event, "")} style={linkstyle} to = "/productlist">SNEAKERS</Link></Box>
               ...
               >
                ...
                <Link to = "/productlist" style={menulinkstyle}><MenuItem onClick = {(event) => handleCategory(event, "Adidas")}>Adidas</MenuItem></Link>
                <Link to = "/productlist" style={menulinkstyle}><MenuItem onClick = {(event) => handleCategory(event, "Jordans")}>Jordans</MenuItem></Link>
                <Link to = "/productlist" ><MenuItem onClick = {(event) => handleCategory(event, "Asics")}>Asics</MenuItem></Link>
